                    ...
                    <div className="flex items-center justify-end gap-1">
                      {onHistory && (
                        <button
                          ...
                          className="px-2 py-1.5 flex items-center gap-1 text-xs font-medium text-amber-700 hover:bg-amber-50 rounded-md transition-colors cursor-pointer"
                          title="سجل حركات وتغييرات هذا المنتج"
                        >
